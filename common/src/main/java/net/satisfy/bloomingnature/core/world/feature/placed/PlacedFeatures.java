...
public class PlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> DENSE_GRASS_PATCH = registerPlacedFeature("grass/dense_grass_patch_placed");
    public static final ResourceKey<PlacedFeature> REGULAR_GRASS_PATCH = registerPlacedFeature("grass/regular_grass_patch_placed");
    public static final ResourceKey<PlacedFeature> SPARSE_GRASS_PATCH = registerPlacedFeature("grass/sparse_grass_patch_placed");
    public static final ResourceKey<PlacedFeature> BLUFF_GRASS_PATCH = registerPlacedFeature("grass/bluff_grass_patch_placed");
