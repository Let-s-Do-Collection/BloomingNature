...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> SWAMP_OAK_LEAVES = registerWithItem("swamp_oak_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES)));
    public static final RegistrySupplier<Block> SWAMP_OAK_SAPLING = registerWithItem("swamp_oak_sapling", () -> new SaplingBlock(new TreeGrower("forest_oak_straight", Optional.empty(), Optional.of(configuredFeatureKey("forest_oak_straight")), Optional.empty()), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING)));    public static final RegistrySupplier<Block> POTTED_SWAMP_OAK_SAPLING = registerWithoutItem("potted_swamp_oak_sapling", () -> new FlowerPotBlock(SWAMP_OAK_SAPLING.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.FLOWER_POT)));
    ...
    public static final RegistrySupplier<Block> SANDSTONE_BRICKS = registerWithItem("sandstone_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BRICKS)));
    public static final RegistrySupplier<Block> SANDSTONE_BRICK_STAIRS = registerWithItem("sandstone_brick_stairs", () -> new StairBlock(SANDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SANDSTONE_BRICKS.get())));
    public static final RegistrySupplier<Block> SANDSTONE_BRICK_SLAB = registerWithItem("sandstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(SANDSTONE_BRICKS.get())));
    public static final RegistrySupplier<Block> SANDSTONE_BRICK_WALL = registerWithItem("sandstone_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(SANDSTONE_BRICKS.get())));
    public static final RegistrySupplier<Block> POLISHED_SANDSTONE_BRICKS= registerWithItem("polished_sandstone_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(SANDSTONE_BRICKS.get())));
    public static final RegistrySupplier<Block> RED_SANDSTONE_BRICKS = registerWithItem("red_sandstone_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.BRICKS)));
    public static final RegistrySupplier<Block> RED_SANDSTONE_BRICK_STAIRS = registerWithItem("red_sandstone_brick_stairs", () -> new StairBlock(RED_SANDSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(RED_SANDSTONE_BRICKS.get())));
    public static final RegistrySupplier<Block> RED_SANDSTONE_BRICK_SLAB = registerWithItem("red_sandstone_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(RED_SANDSTONE_BRICKS.get())));
