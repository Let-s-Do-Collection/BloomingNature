...
public final class AridSurfaceBuilder extends BiolithSurfaceBuilder {
    public enum Profile {CYPRESS_FIELDS}
        ...
        for (int y = 0; y <= topY; y++) {
            ...
            if (slope >= 3) {
                ...
                if (state.is(Blocks.STONE)) {
                    ...
                    if (r < 20) column.setBlock(y, ObjectRegistry.MOSSY_COBBLED_MARLSTONE.get().defaultBlockState());
                    else if (r < 50) column.setBlock(y, ObjectRegistry.COBBLED_MARLSTONE.get().defaultBlockState());
                    else column.setBlock(y, ObjectRegistry.MARLSTONE.get().defaultBlockState());
                } else {
