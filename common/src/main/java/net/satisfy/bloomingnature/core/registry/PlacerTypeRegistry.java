...
import net.satisfy.bloomingnature.core.world.feature.configured.tree.trunk.TallGiantTrunkPlacer;
...
public class PlacerTypeRegistry {
    ...
    public static final RegistrySupplier<TrunkPlacerType<TallGiantTrunkPlacer>> TALL_GIANT_TRUNK_PLACER = TRUNK_PLACER_TYPES.register("tall_giant_trunk_placer", () -> new TrunkPlacerType<>(TallGiantTrunkPlacer.CODEC));
